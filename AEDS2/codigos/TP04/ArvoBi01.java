...
class Arvore {
    ...
    private boolean pesquisar(No no, String elemento, StringBuilder caminho) {
        ...
        comparacoes++;  // Contabilizando a comparação
...
public class ArvoBi01 {
    public static void main(String[] args) {
        ...
        try (FileWriter writer = new FileWriter("854946_arvoreBinaria.txt")) {
            writer.write("854946\t" + durationInSeconds + "\t" + arvore.comparacoes + "\n");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
