...
public class merge {
    ...
    public merge(int id, int generation, String name, String description, String type1, String type2,
    ...
    public static void mergeSort(ArrayList<merge> pokemons, int left, int right, int comparisons[], int movements[]) {
        if (left < right) {
    ...
    private static void merge(ArrayList<merge> pokemons, int left, int mid, int right, int comparisons[], int movements[]) {
        int n1 = mid - left + 1;
        int n2 = right - mid;

        ArrayList<merge> leftArray = new ArrayList<>(pokemons.subList(left, mid + 1));
        ArrayList<merge> rightArray = new ArrayList<>(pokemons.subList(mid + 1, right + 1));
    ...
    public static void main(String[] args) {
        ArrayList<merge> pokemonList = new ArrayList<>();
