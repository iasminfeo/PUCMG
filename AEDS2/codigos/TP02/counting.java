...
public class counting {
    ...
    public counting(int id, int generation, String name, String description, String type1, String type2,
    ...
    public static void countingSort(ArrayList<counting> pokemons) {
        int maxCaptureRate = 0;

        // Encontrar o maior captureRate
        for (counting pokemon : pokemons) {
        ...
        ArrayList<counting> output = new ArrayList<>(Collections.nCopies(pokemons.size(), null));
        ...
        for (int i = pokemons.size() - 1; i >= 0; i--) {
            counting pokemon = pokemons.get(i);
        ...
        // Ordenar por captureRate e nome, mantendo a ordem original em caso de empate
        pokemons.sort(Comparator.comparingInt(counting::getCaptureRateForComparison)
                                 .thenComparing(counting::getNameForComparison));
    }

    public static void main(String[] args) {
        ArrayList<counting> pokemonList = new ArrayList<>();
        ...
        for (counting pokemon : pokemonList) {
