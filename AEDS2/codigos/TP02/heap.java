...
public class heap {
    ...
    public heap(int id, int generation, String name, String description, String type1, String type2,
    ...
    public static void main(String[] args) {
        ArrayList<heap> pokemonList = new ArrayList<>();
        ...
        while (true) {
            ...
            heap pokemon = new heap();
            pokemon.ler(input);
            pokemonList.add(pokemon);
        }

        // Ordena os Pokémons pela ordem alfabética dos nomes
        pokemonList.sort(Comparator.comparing(heap::getNameForComparison));

        // Em seguida, ordena pela altura
        pokemonList.sort(Comparator.comparing(heap::getHeightForComparison)
                .thenComparing(heap::getNameForComparison));

        // Imprime os Pokémons ordenados
        for (heap pokemon : pokemonList) {
