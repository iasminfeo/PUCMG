...
public class quickPARC {
    ...
    public static void quickSort(ArrayList<quickPARC> pokemons, int low, int high, int comparisons[], int movements[]) {
        if (low < high) {
    ...
    private static int partition(ArrayList<quickPARC> pokemons, int low, int high, int comparisons[], int movements[]) {
    ...
    public static void main(String[] args) {
        ArrayList<quickPARC> pokemonList = new ArrayList<>();
        ...
        ArrayList<quickPARC> filteredList = new ArrayList<>();
        for (quickPARC pokemon : pokemonList) {
