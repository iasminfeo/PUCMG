...
REM
REM path|find /i "C:\Icarus_Verilog_v12\bin"         >nul || set path=%path%;C:\Icarus_Verilog_v12\bin
REM path|find /i "C:\Icarus_Verilog_v12\gtkwave\bin" >nul || set path=%path%;C:\Icarus_Verilog_v12\gtkwave\bin
REM
